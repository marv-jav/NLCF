...
public class SpiritualActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        growthRecycler = findViewById(R.id.spirit_recycler);
        ...
        db.collection("spiritual").get().addOnSuccessListener(queryDocumentSnapshots -> {
            if (!queryDocumentSnapshots.isEmpty()) {
                ...
                mProgressBar.setVisibility(View.GONE);
                Toast.makeText(SpiritualActivity.this, "No data found!", Toast.LENGTH_SHORT).show();
            }
        }).addOnFailureListener(e -> Toast.makeText(SpiritualActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show());
