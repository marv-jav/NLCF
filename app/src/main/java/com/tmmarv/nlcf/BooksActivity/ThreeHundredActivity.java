...
public class ThreeHundredActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_three_hundred);

        db = FirebaseFirestore.getInstance();
        mProgressBar = findViewById(R.id.progressBar);

        growthRecycler = findViewById(R.id.three_hundred_recycler);
        ...
        db.collection("three").get().addOnSuccessListener(queryDocumentSnapshots -> {
            if (!queryDocumentSnapshots.isEmpty()) {
                ...
                mProgressBar.setVisibility(View.GONE);
                Toast.makeText(ThreeHundredActivity.this, "No data found!", Toast.LENGTH_SHORT).show();
            }
        }).addOnFailureListener(e -> Toast.makeText(ThreeHundredActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show());
